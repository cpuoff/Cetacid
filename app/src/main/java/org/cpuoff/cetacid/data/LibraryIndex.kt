...
import org.cpuoff.cetacid.READ_PERMISSION
import org.cpuoff.cetacid.UNKNOWN
import org.cpuoff.cetacid.globals.Strings
import org.cpuoff.cetacid.utils.CaseInsensitiveMap
import org.cpuoff.cetacid.utils.ColorSerializer
import org.cpuoff.cetacid.utils.coerceInOrMin
import org.cpuoff.cetacid.utils.distinctCaseInsensitive
import org.cpuoff.cetacid.utils.icuFormat
import org.cpuoff.cetacid.utils.mode
import org.cpuoff.cetacid.utils.modeOrNull
...
fun loadLyrics(track: Track, charsetName: String?): Lyrics? {
    try {
        ...
        Log.e("Cetacid", "Can't load lyrics for ${track.path}", ex)
        return null
    }
}
...
fun AlbumKey(string: String): AlbumKey? {
    try {
        ...
        Log.e("Cetacid", "Attempted to decode an invalid AlbumKey $string", ex)
        return null
    }
}
                ...
                launch {
                    while (true) {
                        ...
                        try {
                            ...
                            Log.e("Cetacid", "Error scanning track ${crudeTrack.path}", ex)
                        }
                    }
                }
            }
...
private fun scanTrack(
    ...
    if (advancedMetadataExtraction) {
        try {
            ...
            Log.e("Cetacid", "Error reading extended metadata for $path", ex)
        }
    }
